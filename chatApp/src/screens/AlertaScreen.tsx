...
export interface AlertaScreenProps {
...
let API = new api();
class AlertaScreen extends React.Component<AlertaScreenProps, state> {
    constructor(props: Readonly<AlertaScreenProps>){
      super(props);
      this.state = {
        loading:false,
      }
    ...
    setFooterActive=async ()=>{
      try {
        await AsyncStorage.mergeItem('activeButton', JSON.stringify('alerta'))
        console.log("cambio activo alerta")
      } catch (e) {
        // saving error
      }
    }
